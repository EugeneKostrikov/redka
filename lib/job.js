...
Job.prototype.serialize = function(){
  return _.extend({}, _.omit(this, 'serialize', 'retry'), {
    params: _.isObject(this.params) ? JSON.stringify(this.params) : this.params,
    result: _.isObject(this.result) ? JSON.stringify(this.result) : this.result,
    error: _.isObject(this.error) ? JSON.stringify(this.error) : this.error
  });
};
